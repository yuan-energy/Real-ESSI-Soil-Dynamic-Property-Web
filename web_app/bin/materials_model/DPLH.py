...
class DPLH(object):
	...
	def POST(self):
		...
		argv.append(float(form.initial_confine))
		...
		command = "script -c './test_dplh " + arg + " ' log" 
		...
		# ============================================
		inFilename = 'DPLH_strain_stress.txt'
		...
		plt.grid()
		plt.savefig("DPLH_strain_stress.png", bbox_inches='tight')
		...
		plt.xscale('log')
		plt.grid()
		plt.savefig("DPLH_G_Gmax.png", bbox_inches='tight')
		...
		plt.xscale('log')
		plt.grid()
		plt.savefig("DPLH_damping_ratio.png", bbox_inches='tight')



		mylog.close()
		test =1 
		return render.DPLH_refresh(argv)
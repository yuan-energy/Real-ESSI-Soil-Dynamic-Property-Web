...
class DPAF(object):
	...
	def POST(self):
		...
		# ============================================
		inFilename = 'DPAF_strain_stress.txt'
		...
		plt.grid()
		plt.savefig("DPAF_strain_stress.png", bbox_inches='tight')
		...
		plt.ylim([minY, maxY])
		plt.grid()
		plt.savefig("DPAF_G_Gmax.png", bbox_inches='tight')
